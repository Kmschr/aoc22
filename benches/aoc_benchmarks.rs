...
pub fn day_8_part_1(c: &mut Criterion) {
    c.bench_function("Day 8 Part 1", |b| b.iter(|| day8::part1()));
}

pub fn day_8_part_2(c: &mut Criterion) {
    c.bench_function("Day 8 Part 2", |b| b.iter(|| day8::part2()));
}

pub fn day_9_part_1(c: &mut Criterion) {
    c.bench_function("Day 9 Part 1", |b| b.iter(|| day9::part1()));
}

pub fn day_9_part_2(c: &mut Criterion) {
    c.bench_function("Day 9 Part 2", |b| b.iter(|| day9::part2()));
}

pub fn day_10_part_1(c: &mut Criterion) {
    c.bench_function("Day 10 Part 1", |b| b.iter(|| day10::part1()));
}

pub fn day_10_part_2(c: &mut Criterion) {
    c.bench_function("Day 10 Part 2", |b| b.iter(|| day10::part2()));
}
...
criterion_group!(day_8, day_8_part_1, day_8_part_2);

criterion_group!(day_9, day_9_part_1, day_9_part_2);

criterion_group!(day_10, day_10_part_1, day_10_part_2);
